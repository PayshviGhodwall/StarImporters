    ...
    <div>
      <div className="star_imp_app">
        ...
        >
          ...
          <p>
            {/* <span>
              Star Importers built the Star Importers app as a Free app. This
              SERVICE is provided by Star Importers at no cost and is intended
              for use as is.
              
              By using this website or downloading & using the
              app, these terms will automatically apply to you – you should make
              ...
              it, still belong to Star Importers. This app is allowed to sell
              Tobacco Licenced Products..Please upload proper documents and
              licences for valid purchase. Star Importers is committed to
              ...
              never charge you for the app or its services without making it
              very clear to you exactly what you’re paying for. The Star
              Importers app stores and processes personal data that you have
              ...
              the Star Importers app won’t work properly or at all. Link to
              Terms and Conditions of third-party service providers used by the
              app Google Play Services Google Analytics for Firebase Firebase
              Crashlytics You should be aware that there are certain things that
              Star Importers will not take responsibility for. Certain functions
              ...
              network provider, but Star Importers cannot take responsibility
              ...
              left. If you’re using the app outside of an area with Wi-Fi, you
              ...
              using the app. Along the same lines, Star Importers cannot always
              take responsibility for the way you use the app i.e. You need to
              make sure that your device stays charged – if it runs out of
              battery and you can’t turn it on to avail the Service, Star
              Importers cannot accept responsibility. With respect to Star
              Importers’s responsibility for your use of the app, when you’re
              ...
              do rely on third parties to provide information to us so that we
              can make it available to you. Star Importers accepts no liability
              ...
              Android & iOS – the requirements for the both systems(and for any
              ...
              want to keep using the app. Star Importers does not promise that
              ...
              effective as of 2023-02-27 Contact Us If you have any questions or
